...
uIcon varchar(50) not null default '../resource/icon.png',
...
insert into HRTopUp values (null,2,'card',default);

#delete from HRRental where rDeal is null;
#alter table HRRental MODIFY rDeal timestamp  default now();